...
//     divTitle.innerText = `${arrayElement.title}`;
//     divMain.append(divTitle);
//
//     let divMonthDuration = document.createElement('div');
//     divMonthDuration.innerText = `monthDuration - ${arrayElement.monthDuration}`;
//     divMain.append(divMonthDuration);
//
//     let divHourDuration = document.createElement('div');
//     divHourDuration.innerText = `hourDuration - ${arrayElement.hourDuration}`;
//     divMain.append(divHourDuration);
//
...
// document.body.appendChild(mainDiv.cloneNode(true));
//
// - Є масив:
// let lii = ['Main', 'Products', 'About us', 'Contacts']
// // Взяти файл template1.html та додати в нього скріпт котрий для кожного елементу масиву створює li та додає його до блоку .menu
// // Завдання робити через цикли.
//
// for (const string of lii) {
